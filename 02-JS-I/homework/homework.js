...
function devolverString(str) {
  ...
  var cadena = 'Esta es una función'; // Tu código:
  return str;
}
...
function esPositivo(numero) {
  ...
  if (numero > 0){
    var msj1 = 'Es positivo';
    return msj1;
  }else if (numero < 0){
    var msj2 = 'Es negativo';
    return msj2;
  }else if(numero === 0){
    return false;
  }
